...
function AboutMe() {
  ...
  return (
    <div className={`max-w-5xl mx-auto p-6 space-y-16 font-sans text-gray-800 transition-all duration-1000 ${ isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
        <header className="text-center space-y-4">
            <h1 className="text-5xl font-bold text-primary">Mon Parcours Professionnel</h1>
            <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
                35 ans d'expérience dans l'animation pour personnes âgées, guidée par la conviction
                de placer la personne au cœur de ses choix.
            </p>
        </header>
        <section className="relative">
        <div className="absolute top-0 left-6 md:left-1/2 transform md:-translate-x-1/2 w-1 bg-primary/20 h-full rounded-full"></div>
            <div className="relative mb-12 flex flex-col md:flex-row md:even:flex-row-reverse items-center">
                <div className="md:w-1/3 flex items-center justify-center p-4">
                    ...
                    src={animateur}
                    alt="Animateur"
                    className="w-48 h-48 md:w-64 md:h-64 rounded-full object-cover shadow-lg hover:scale-105 transition-transform duration-500"
                    />
                </div>
                <div className="md:w-2/3 bg-white rounded-xl shadow-lg p-6 space-y-4">
                    <h2 className="text-2xl font-semibold text-secondary">1993 — Préambule</h2>
                    <p className="leading-relaxed">
                        Dès 1993, cette philosophie s'est traduite par la mise en place d'animations profondément innovantes, comme l'organisation d'un séjour de vacances pour les résidents de cinq maisons de retraite.                     
                    </p>
                    <p>
            ...
            <div className="relative mb-12 flex flex-col md:flex-row items-center">
                <div className="md:w-2/3 bg-white rounded-xl shadow-lg p-6 space-y-4">
                    <h2 className="text-2xl font-semibold text-primary">2025 — Projets et Réalisations</h2>
                    <div className="border-l-4 border-primary pl-4 space-y-3">
                        <h3 className="text-xl font-medium text-secondary">Création d'un Arbre de Vie</h3>
                        <p className="text-gray-800 font-medium">LEMPEREUR P, FAYAD B et l’équipe pédagogique de l’école du Terne.</p>
                        <p className="text-gray-700">EHPAD "Les Vertes Années" | Projet intergénérationnel et thérapeutique</p>
                        <div className="flex flex-wrap gap-2">
                            {[
            ...
            <div className="relative mb-12 flex flex-col md:flex-row-reverse items-center">
                <div className="md:w-2/3 bg-white rounded-xl shadow-lg p-6 space-y-4">
                    <h2 className="text-2xl font-semibold text-primary">2010-2025 — Compétences et Méthodologies</h2>
            ...
            <div className="relative mb-12 flex flex-col md:flex-row items-center">
                <div className="md:w-2/3 bg-white rounded-xl shadow-lg p-6 space-y-4">
                    <h2 className="text-2xl font-semibold text-primary">1995-2025 — Postes et Responsabilités</h2>
                    <div className="border-l-4 border-primary pl-4 space-y-3">
                        <h3 className="text-xl font-medium text-secondary">
                            Responsable du service d’animation de l'EHPAD & Chef de Projet Animation de l'association GAMA
                        </h3>
